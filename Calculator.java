...
import javax.swing.*;
  ...
  public class Calculator extends JFrame {
   ...
   public Calculator() {
          ...
          p1.add(jbtquit = new JButton("Quit"));
           ...
           jbtquit.addActionListener(new ListenToquit());
    } 

    
    class ListenToquit implements ActionListener{
    	
    	public void actionperformed (ActionEvent e) {
            jbtquit = new JButton("Quit");
            jbtquit.setToolTipText("Want to quit?");
            jbtquit.addActionListener((event) -> System.exit(0));
